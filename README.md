...
拠点でゆっくり注文するUberEatsが横2.5画像というUIを採択しているからで、ここをベースに3画像が多めの情報であり、画面を引き目にスキャンできるというふうに色々試行錯誤して決めました。
<dev>
...
- UIはXMLからjetpackConposeへ移行し、モダンで
 
- データベースはSQLiteから、Room,firebase,SQL
