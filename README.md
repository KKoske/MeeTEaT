...
帰り道に外で食事を購入して帰ろうとする人の思考の順番を仮定していて、1:食事を探そうという気分　→2：何があるか情報を得ようとする　→3：得た情報から一番食べたいという、理想を探す　→4：その理想を元に、一番食事購入の実現度が高いを購入するの流れになります。想定シチュエーションにおける、食事購入心理の仮説に対して、2の部分を素早く満たすために横を３画像分と多めの情報を見やすくしているというわけです。なぜ３画像が情報量が多いかというのは、拠点でゆっくり注文するUberEatsが横2.5画像というUIを採択しているからで、ここをベースに3画像が多めの情報であり、画面を引き目にスキャンできるというふうに色々試行錯誤して決めました。
